...
async fn test_answerer_ice_restart_answer_does_not_unblock_before_connected() {
    ...
    // Give the OutprocOutGate listener a scheduling turn. Before this fix,
    // handle_ice_restart_offer broadcast IceRestartCompleted immediately after
    // sending Answer, which cleared the recovery guard before ICE was usable.
